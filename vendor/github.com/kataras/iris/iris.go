...
import (
	...
	"server/vendor/github.com/kataras/iris/core/errgroup"
	"server/vendor/github.com/kataras/iris/core/host"
	"server/vendor/github.com/kataras/iris/core/netutil"
	"server/vendor/github.com/kataras/iris/core/router"

	// handlerconv conversions
	"server/vendor/github.com/kataras/iris/core/handlerconv"
	// cache conversions
	"server/vendor/github.com/kataras/iris/cache"
	// view
	"server/vendor/github.com/kataras/iris/view"
	// middleware used in Default method

	requestLogger "server/vendor/github.com/kataras/iris/middleware/logger"
	"server/vendor/github.com/kataras/iris/middleware/recover"
)
