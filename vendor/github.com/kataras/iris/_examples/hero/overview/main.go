...
import (
	"server/vendor/github.com/kataras/iris/_examples/hero/overview/datasource"
	"server/vendor/github.com/kataras/iris/_examples/hero/overview/repositories"
	"server/vendor/github.com/kataras/iris/_examples/hero/overview/services"
	"server/vendor/github.com/kataras/iris/_examples/hero/overview/web/middleware"
	"server/vendor/github.com/kataras/iris/_examples/hero/overview/web/routes"

	"server/vendor/github.com/kataras/iris"
	"server/vendor/github.com/kataras/iris/hero"
)
