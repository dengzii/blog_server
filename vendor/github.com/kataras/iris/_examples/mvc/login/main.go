...
import (
	...
	"server/vendor/github.com/kataras/iris/_examples/mvc/login/datasource"
	"server/vendor/github.com/kataras/iris/_examples/mvc/login/repositories"
	"server/vendor/github.com/kataras/iris/_examples/mvc/login/services"
	"server/vendor/github.com/kataras/iris/_examples/mvc/login/web/controllers"
	"server/vendor/github.com/kataras/iris/_examples/mvc/login/web/middleware"

	"server/vendor/github.com/kataras/iris"
	"server/vendor/github.com/kataras/iris/mvc"
	"server/vendor/github.com/kataras/iris/sessions"
)
