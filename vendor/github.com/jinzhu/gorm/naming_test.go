...
func TestTheNamingStrategy(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "auth", expected: "auth", namer: TheNamingStrategy.DB},
		{name: "userRestrictions", expected: "user_restrictions", namer: TheNamingStrategy.Table},
		{name: "clientID", expected: "client_id", namer: TheNamingStrategy.Column},
	}
