...
func createCallback(scope *Scope) {
	if !scope.HasError() {
		...
		lastInsertIDReturningSuffix := LastInsertIDReturningSuffix(quotedTableName, returningColumn)
		...
		if lastInsertIDReturningSuffix == "" || primaryField == nil {
			...
			if primaryField.Field.CanAddr() {
				if err := QueryRow(scope.SQL, scope.SQLVars...).Scan(primaryField.Field.Addr().Interface()); scope.Err(err) == nil {
