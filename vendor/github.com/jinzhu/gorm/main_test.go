...
func OpenTestConnection() (db *DB, err error) {
	...
	case "mssql":
		...
		db, err = Open("mssql", dbDSN)
	default:
		fmt.Println("testing sqlite3...")
		db, err = Open("sqlite3", filepath.Join(os.TempDir(), "gorm.db"))
	}
